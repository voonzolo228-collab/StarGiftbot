...
BOT_TOKEN = "7777777777:AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA"  # ТОКЕН ВІД @BOTFATHER
API_ID = 1234567  # ЧИСЛО З my.telegram.org
API_HASH = "abcdef1234567890ghijklmnopqrstuv"  # СТРОКА З my.telegram.org
TARGET_ACCOUNT = "@my_safe_account"  # ВАШ ЮЗЕРНЕЙМ (КУДА ПРИЙДУТЬ ПОДАРКИ)
