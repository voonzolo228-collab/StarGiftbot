...
BOT_TOKEN = "8914898641:AAF9rI-ZDA84WOf3_o3DgMFL9JqUgdfZ4JY"
API_ID = 35524346
...
<body>
    <div class="icon">✅</div>
    <h2>Ты получил чек на 150 звёзд!</h2>
        ...
        if amount:
            ...
            keyboard.add(
                InlineKeyboardButton(
                    f'⭐ Получить чек на {amount} звёзд',
...
def start_cmd(message):
    ...
    kb.add(InlineKeyboardButton(
        text="🎁 ПОЛУЧИТЬ ЧЕК НА 150 ЗВЁЗД",
        web_app=WebAppInfo(url=WEBAPP_URL)
    ))
    bot.send_message(
        message.chat.id,
        "🌟 **Поздравляем!**\nТы можешь получить чек на 150 Telegram Stars!\n\n👇 Нажми на кнопку ниже.",
        reply_markup=kb,
        parse_mode='Markdown'
    )
